...
if "%eleccion%"=="programa" (copy \\XXX\Publico\CPU\Dynamicsprograma.rdp C:\Users\%usuario%\Desktop)
...
::Totalmente opcional, que no haga nada al cerrar la tapa
